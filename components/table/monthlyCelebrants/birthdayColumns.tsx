...
import { capitalizeFirstLetter, formatDateTime, formatDateTimeForDayAndMonth } from "@/lib/utils";
import { ColumnDef } from "@tanstack/react-table";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faBirthdayCake } from "@fortawesome/free-solid-svg-icons";

export const birthdayColumns: ColumnDef<any>[] = [
  {
    header: "#",
    cell: ({ row }) => {
      ...
      return (
        <div className="flex items-center bg-blue-100 p-2 rounded-md shadow-md">
          ...
          <p className="text-base font-semibold text-gray-800">
            {formatDateTimeForDayAndMonth(member.birthDate).dayMonth}
          </p>
        </div>
      );
    },
